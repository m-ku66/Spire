...
//         // Move camera to follow the stack
//         setCameraPosition(blocksRef.current.length * 2);

//         console.log(`Block ${newBlock.index} added to game`);
//     };

//     // Camera animation function (like original setCamera)
//     const setCameraPosition = (y: number, speed: number = 0.3) => {
//         const context = contextRef.current;
//         if (!context) return;

//         console.log(`Setting camera to y=${y + 4}, looking at y=${y}`);

//         // Update camera position to follow the stack
//         context.camera.position.y = y + 4;
...
//             //     choppedMesh.position[fallDirection] += fallSpeed * progress * 0.016;
//             // } else {
//             //     choppedMesh.position[fallDirection] -= fallSpeed * progress * 0.016;
//             // }
...
//     const gameTick = () => {
//         // console.log(`gameTick called: gameState=${gameStateRef.current}, blocks=${blocksRef.current.length}`);

//         if (gameStateRef.current === GAME_STATES.PLAYING && blocksRef.current.length > 0) {
//             const currentBlock = blocksRef.current[blocksRef.current.length - 1];
//             // console.log(`Current block:`, currentBlock ? `Block ${currentBlock.index}, state=${currentBlock.state}` : 'null');

//             if (currentBlock) {
//                 // console.log(`About to call tick on Block ${currentBlock.index}`);
//                 currentBlock.tick(); // This will finally work!
//             }
//         }
//     };
...
//         // console.log(`Actual render dimensions: ${actualWidth}x${actualHeight}`);
//         // console.log(`Aspect ratio: ${aspect}`);
//         // console.log(`Current renderer size: ${context.renderer.domElement?.width || 'N/A'}x${context.renderer.domElement?.height || 'N/A'}`);
//         // console.log(`Current camera bounds: left=${context.camera.left}, right=${context.camera.right}, top=${context.camera.top}, bottom=${context.camera.bottom}`);
...
//             // console.log(`Renderer setSize called with ${width}x${height}`);
//             // console.log(`Renderer viewport set to ${actualWidth}x${actualHeight}`);
//         } catch (error) {
...
//         // console.log(`New camera bounds: left=${newLeft}, right=${newRight}, top=${newTop}, bottom=${newBottom}`);
...
//             // console.log(`Logical screen dimensions: ${screenWidth}x${screenHeight}`);
//             // console.log(`Screen dimensions (pixels): ${screenWidthPixels}x${screenHeightPixels}`);
//             // console.log(`WebGL context:`, gl);

//             // Get actual WebGL drawing buffer dimensions
//             const actualWidth = gl.drawingBufferWidth || screenWidth;
//             const actualHeight = gl.drawingBufferHeight || screenHeight;
//             // console.log(`Actual WebGL buffer dimensions: ${actualWidth}x${actualHeight}`);
...
//             // console.log(`Renderer size set to ${screenWidth}x${screenHeight}`);
//             // console.log(`Renderer viewport set to ${actualWidth}x${actualHeight}`);
//             // console.log(`Renderer domElement size: ${renderer.domElement?.width || 'N/A'}x${renderer.domElement?.height || 'N/A'}`);
...
//             // console.log(`Camera aspect ratio: ${aspect} (using actual dimensions)`);
//             // console.log(`Camera d value: ${d}`);
...
//             // console.log(`Initial camera bounds: left=${-d * aspect}, right=${d * aspect}, top=${d}, bottom=${-d}`);
...
//             // console.log(`Camera positioned at: (2, 4, 2) looking at (0, 0, 0)`);
...
//         // Remove explicit width/height to let flex handle it
//     },
//     glView: {
//         flex: 1,
//         // Let the GLView fill the entire container
//         // Remove explicit dimensions to prevent conflicts
//     },
//     uiOverlay: {
//         position: 'absolute',
//         top: 0,
